...
<header>
    ...
    <div class="paramain">
        ...
        <!-- Overskrift -->
        <h1>Legge inn bøker i databasen</h1>

        <!-- Inkluderer insert filen -->
        <?php
        include 'INSERT/INSERT_Book.php'
        ?>

        <!-- Legger inn skjemaet på siden. Brukes av insert filen -->
        <form method="POST">
            <input type="text" name="BokNavn">
            Bok navn
        ...
        <!-- Viser hvilke bøker som er i databasen -->
        <h1>Bøker i databasen</h1>
        <?php
        include 'SELECT/SELECT_Book.php'
        ?>
    </div>
