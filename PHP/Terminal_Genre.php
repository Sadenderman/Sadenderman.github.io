...
<header>
    <nav>
      <ul>
        ...
        <li><a href="/socials.html">Kontakt meg!</a></li>
            ...
            <h1 class="headmain">PHP Sjanger</h1> <br/>
    ...
    <?php
    include 'INSERT/INSERT_Genre.php'
    ?>

    <!-- Legger inn skjemaet på siden. Brukes av insert filen -->
    <form method="POST">
        <input type="text" name="SjangerNavn">
        Sjanger
    ...
    <h1>Sjangere i databasen</h1>
    <?php
    include 'SELECT/SELECT_Genre.php'
    ?>
    </div>
